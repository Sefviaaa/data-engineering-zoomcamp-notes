...
In this homework, we'll prepare data for the next week. We'll need to put these datasets to our data lake:
...
If you don't have access to GCP, you can do that locally and ingest data to Postgres instead. If you have access to GCP, you don't need to do it for local Postgres -
only if you want.
...
[step-by-step + code](2022/step-by-step%20+%20code.md)
...
[step-by-step](2022/step-by-step.md)
...
- Form for submitting: [https://forms.gle/ViWS8pDf2tZD4zSu5](https://forms.gle/ViWS8pDf2tZD4zSu5)
- You can submit your homework multiple times. In this case, only the last submission will be used.

Deadline: February 7, 17:00 CET

[solution.py](2022/solution%20py.md)

[complete_dag.py](2022/complete_dag%20py.md)